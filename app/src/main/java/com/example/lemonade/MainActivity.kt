...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        savedInstanceState?.let {
            ...
            lemonSize = it.getInt(LEMON_SIZE, -1)
            squeezeCount = it.getInt(SQUEEZE_COUNT, -1)
        }
        // === END IF STATEMENT ===
        ...
        when (lemonadeState) {
            ...
            SELECT -> {
                ...
                lemonImage?.apply {
                    ...
                    contentDescription = getString(R.string.image_desc_lemon)
                }
            }
            SQUEEZE -> {
                textAction.setText(R.string.lemon_squeeze)
                lemonImage?.apply {
                    setImageResource(R.drawable.lemon_squeeze)
                    contentDescription = getString(R.string.image_desc_lemon)
                }
            }
            DRINK -> {
                ...
                lemonImage?.apply {
                    setImageResource(R.drawable.lemon_drink)
                    contentDescription = getString(R.string.image_desc_full_glass)
                }
            }
            RESTART -> {
                ...
                lemonImage?.apply {
                    ...
                    contentDescription = getString(R.string.image_desc_empty_glass)
                }
            }
        }
    }
